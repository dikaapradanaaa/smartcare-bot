...
const HeroContent = {
   /* title: "Hello we, are <br/> Dsn Grid",*/
    subtitle: `Shieldero VPN: Elevate your privacy to new heights.`,
    description: `Browse the internet freely and anonymously with our decentralized bandwidth marketplace and stake-weighted randomized server selection. <span class="mb-10 d-block" ></span>
     Say goodbye to reliance on a single ISP and hello to enhanced protection against potential trackers and hackers.`,
